    ...
    <footer className={styles.footer}>
      <div className={`${styles.container} container p-x`}>
        ...
        <div className={`${styles.links} ${styles.col1}`}>
          ...
          {user && user.role === "admin" ? <a>Devenir auteur</a> : null}
          <Link href={"/#about"}>
            <a>À propos</a>
          </Link>
        </div>
        ...
        <div className={styles.cta}>
          ...
          {theme === "system" && systemTheme === "dark" ? (
            <div className={styles.theme} onClick={() => setTheme("light")}>
              <RiSunFill size={27} />
            </div>
          ) : null}
          {theme === "system" && systemTheme === "light" ? (
            <div className={styles.theme} onClick={() => setTheme("dark")}>
              <RiMoonFill size={27} />
            </div>
          ) : null}
          {theme === "dark" ? (
      ...
      <div className={styles.signature}>
        Coded with ❤️ by{" "}
        <a href="https://github.com/omelette-watin" target={"_blank"}>
          Omelette
        </a>
      </div>
    </footer>
